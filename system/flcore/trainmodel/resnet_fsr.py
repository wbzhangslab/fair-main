...
class ResNet_FSR(nn.Module):
    ...
    def forward(self, x, is_eval=False):
        ...
        # return: 校正后的输出 鲁棒特征输出 非鲁棒特征输出 校正特征输出
        return out, r_outputs, nr_outputs, rec_outputs 
    

def ResNet18_FSR(num_classes=10, tau=0.1, image_size=(32, 32)):
    return ResNet_FSR(BasicBlock, [2, 2, 2, 2], num_classes=num_classes, tau=tau, image_size=image_size)
